        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              {/* Floating Badge */}
              <div className="absolute -top-8 left-4 bg-gradient-to-r from-green-500/90 to-emerald-500/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg z-10">
              ...
              <div className="relative">
                {/* Subtle glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent rounded-xl blur-2xl scale-90"></div>

                <Image
                  src="/cta.png"
                  alt="NeoHealth AI Assistant"
                  width={300}
                  height={300}
                  className="relative w-110 h-auto drop-shadow-xl hover:scale-120 transition-transform scale-115 duration-500"
                  priority
                />
              </div>
