...
function Hero() {
  return (
    <section className="relative h-screen flex overflow-hidden items-center pt-20">
      {/* GRID BG  */}
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium text-primary">AI-Powered Medical Assistant</span>
                </div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our AI medical assistant for instant advice, book smart appointments, and
