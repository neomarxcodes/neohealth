              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Upgrade to AI Pro or AI Basic to unlock unlimited voice consultations with our AI medical assistant.
                  </p>
                </div>
              </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
          <CardContent className="relative p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The voice assistant feature is available to AI Pro and AI Basic subscribers. Get instant medical advice through natural voice conversations.
            </p>
