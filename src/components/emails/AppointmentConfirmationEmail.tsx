...
function AppointmentConfirmationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your health appointment has been confirmed</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              ...
              style={logo}
            />
            <Text style={logoText}>NeoHealth</Text>
          </Section>
          ...
          <Text style={text}>
            Your health appointment has been successfully booked. Here are the details:
          </Text>
          ...
          <Section style={appointmentDetails}>
            ...
            <Text style={detailValue}>Health Center</Text>
          </Section>
          ...
          <Text style={footerText}>
            If you have any questions, please contact us at support@neohealth.com
          </Text>
        </Container>
      </Body>
    </Html>
