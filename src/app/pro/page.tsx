...
async function ProPage() {
  ...
  // const hasProPlan = has({ plan: "ai_basic" }) || has({ plan: "ai_pro" }) // check if user has a pro plan, coming directly from clerk documentation
        ...
        <div className="mb-12 overflow-hidden">
          <div className="flex items-center justify-between bg-gradient-to-br from-primary/10 to-background rounded-3xl p-8 border border-primary/20">
            <div className="space-y-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">Unlock Premium AI Medical Care</h1>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Select the perfect plan for your medical care needs. All plans include secure access and bank-level encryption.
            </p>
          </div>
